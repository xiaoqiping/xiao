...
#options.add_argument('--proxy-server=http://119.31.210.170:7777')
browser = webdriver.Chrome(executable_path="D:\chromedriver")
browser.set_page_load_timeout(60)
browser.set_script_timeout(60)

#get_module(1047, 'http://www.mlcc1.com/mlcc_list/brand/11/id/136354/p/438.html')
...
# python D:\spider\mlcc_goods_series_module_selenium_chrome.py
