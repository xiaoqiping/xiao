...
# 登录之后，百度首页的请求cookies，必填BDUSS
COOKIES = 'VBSYVB4YkR6ZWU5eXRDcFFBZUtRYWUyM09GY1VwVXl3dTR2WkwxWU43R2taNkZlSVFBQUFBJCQAAAAAAAAAAAEAAAA0KLMkeGlhb3FpcGluZzMwMQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAKTaeV6k2nleO'
...
class BaiduIndex:
    ...
    def http_get(url, cookies=COOKIES):
        ...
        cookies = {'BDUSS': 'VBSYVB4YkR6ZWU5eXRDcFFBZUtRYWUyM09GY1VwVXl3dTR2WkwxWU43R2taNkZlSVFBQUFBJCQAAAAAAAAAAAEAAAA0KLMkeGlhb3FpcGluZzMwMQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAKTaeV6k2nleO'}
...
if __name__ == '__main__':
    # 最多同时请求5个关键词
    baidu_index = BaiduIndex(keywords=['崂山门票'], start_date='2014-01-01', end_date='2017-12-31')

    # 获取全部5个关键词的全部数据
    print(baidu_index.result['崂山门票']['all'])
    # 获取1个关键词的全部数据
    #print(baidu_index.result['崂山门票'])
    # 获取1个关键词的移动端数据
