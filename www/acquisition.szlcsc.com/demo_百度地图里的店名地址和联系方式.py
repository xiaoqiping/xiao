...
def BusinessFromBaiduDitu(citycode = '287',key_word='筛网',pageno=0):
    ...
    htm = text.encode('latin-1').decode('unicode_escape') # 转码.encode('latin-1').decode('unicode_escape')
...
# 建立csv文件，保存数据
csvFile = open(r'file/百度地图/Data/%s.csv' % 'CityData', 'a+', newline='', encoding='utf_8_sig')
